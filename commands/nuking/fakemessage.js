...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const name = interaction.option.getString('name') | "discord.gg/frosted"
        const messageCount = interaction.option.getString('count');
        const messagesInput = interaction.option.getString('messages')
