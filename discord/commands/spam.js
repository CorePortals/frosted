    ...
    command: new SlashCommandBuilder()
        ...
        execute: async (interaction) => {
            ...
            try {
                ...
                const customMessage2 = interaction.options.getString('custommessage2') || waterwark;
                ...
                function startSpam() {
                    ...
                    const interval = setInterval(() => {
                        ...
                        for (let i = 0; i < 50000 && messageCount < packetCount; i++) {
                            ...
                            let message2 = customMessage2 + (bypass ? ` ${generateRandomString(8)}` : '');
                            let command2;
                            if (rainbow) {
                                switch (spamType) {
                                    case 1:
